  ...
  properties: [
    {
      ...
      operation: 'Venta',
      price_data: { amount: 185000, currency: 'USD', expenses: 0 },
      media: ['https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&q=80&w=1200', 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=1200', 'https://images.unsplash.com/photo-1600607687931-cebf1daef506?auto=format&fit=crop&q=80&w=1200'],
      attributes: { rooms: 5, m2: 170, bedrooms: 3, baths: 3, amenities: ['Piscina', 'Cochera x2'] },
    ...
    },
    {
      ...
      operation: 'Alquiler',
      price_data: { amount: 450, currency: 'USD', expenses: 8000 },
      media: ['https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=1200'],
      attributes: { rooms: 2, m2: 55, bedrooms: 1, baths: 1, amenities: ['Balcón', 'Sum'] },
    ...
    },
    {
      ...
      operation: 'Venta',
      price_data: { amount: 320000, currency: 'USD', expenses: 20000 },
      media: ['https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=1200'],
      attributes: { rooms: 6, m2: 600, bedrooms: 4, baths: 3, amenities: ['Gym', 'Piscina'] },
    ...
    },
    {
      ...
      operation: 'Venta',
      price_data: { amount: 75000, currency: 'USD', expenses: 5000 },
      media: ['https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&q=80&w=1200'],
      attributes: { rooms: 0, m2: 800, bedrooms: 0, baths: 0, amenities: ['Seguridad'] },
    ...
    },
    {
      ...
      operation: 'Alquiler',
      price_data: { amount: 800, currency: 'USD', expenses: 12000 },
      media: ['https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=1200'],
      attributes: { rooms: 3, m2: 120, bedrooms: 0, baths: 2, amenities: ['Apto Profesional'] },
    ...
    },
    {
      ...
      operation: 'Venta',
      price_data: { amount: 110000, currency: 'USD', expenses: 4000 },
      media: ['https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=1200'],
      attributes: { rooms: 3, m2: 90, bedrooms: 2, baths: 2, amenities: ['Patio', 'Parrilla'] },
